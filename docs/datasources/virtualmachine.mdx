...
description: |
  ...
  vSphere and returns the name and attached tags of a virtual machine that
  matches all specified filters. This virtual machine can be used in the
  vSphere Clone builder to select a template.
