...
type FlatConfig struct {
	...
	MostFreeMemory      *bool             `mapstructure:"most_free_memory" cty:"most_free_memory" hcl:"most_free_memory"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"most_free_memory":           &hcldec.AttrSpec{Name: "most_free_memory", Type: cty.Bool, Required: false},
	}
	return s
}
...
type FlatSummary struct {
	MemoryCapacity *int64 `mapstructure:"memory_capacity" cty:"memory_capacity" hcl:"memory_capacity"`
	MemoryFree     *int64 `mapstructure:"memory_free" cty:"memory_free" hcl:"memory_free"`
}
...
func (*FlatSummary) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		"memory_capacity": &hcldec.AttrSpec{Name: "memory_capacity", Type: cty.Number, Required: false},
		"memory_free":     &hcldec.AttrSpec{Name: "memory_free", Type: cty.Number, Required: false},
	}
	return s
}
